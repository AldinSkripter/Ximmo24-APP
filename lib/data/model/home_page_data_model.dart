...
class HomePageDataModel implements NativeAdWidgetContainer {
  ...
  factory HomePageDataModel.empty() {
    return const HomePageDataModel(
      ...
      premiumProjectSection: <ProjectModel>[],
  ...
  final List<ProjectModel>? premiumProjectSection;
  ...
  HomePageDataModel copyWith({
    ...
    List<ProjectModel>? premiumProjectSection,
    ...
    return HomePageDataModel(
      ...
      premiumProjectSection:
          premiumProjectSection ?? this.premiumProjectSection,
...
class HomePageSection {
  ...
  factory HomePageSection.fromJson(Map<String, dynamic> json) {
    return HomePageSection(
      ...
      title: (json['app_title'] ?? json['title'] ?? '')?.toString(),
      translatedTitle:
          (json['translated_app_title'] ?? json['translated_title'] ?? '')
              ?.toString(),
