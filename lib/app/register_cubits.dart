...
class RegisterCubits {
  List<SingleChildWidget> register() {
    return [
      BlocProvider(create: (context) => PaymentIntentCubit()),
      BlocProvider(create: (context) => FetchAdBannersCubit()),
      BlocProvider(create: (context) => FetchStoriesCubit()),
      BlocProvider(create: (context) => UploadStoryCubit()),
      BlocProvider(create: (context) => DeleteStoryCubit()),
      BlocProvider(create: (context) => FetchMyStoriesCubit()),
      ...
      BlocProvider(create: (context) => FetchProjectsListCubit()),
      BlocProvider(create: (context) => FetchMyProjectsCubit()),
      BlocProvider(create: (context) => HomePageInfinityScrollCubit()),
      BlocProvider(
        create: (context) =>
            LoginCubit(userDetailsCubit: context.read<UserDetailsCubit>()),
      ),
      ...
      BlocProvider(create: (context) => PlaceAutocompleteCubit()),
      BlocProvider(create: (context) => PlaceDetailsCubit()),
