...
class AppIcons {
  ...
  static const String _socialMediaPath = 'social_media/';
  ...
  static final String fallbackAgentBanner = _asset('fallback_agent_banner.png');
  ...
  static const String chatBackground = 'assets/chat_background/doodle.png';
  ...
  static final String preferences = _asset('${_svgPath}preferences.svg');
  static final String edit = _asset('${_svgPath}edit.svg');
  static final String gallery = _asset('${_svgPath}gallery.svg');
  ...
  static final String whatsapp = _asset('${_svgPath}whatsapp.svg');
  ...
  static final String calendarFilled = _asset('${_svgPath}calendar_filled.svg');
  ...
  static final String watermark = _asset('${_svgPath}watermark.svg');
  ...
  static final String loading = _asset('${_appIconPath}ic_launcher.png');
  ...
  static final String becomeAgentReview = _asset(
    '${_multiColorPath}become_agent_under_review.svg',
  );
  ...
  // Social media
  static final String facebook = _asset('${_socialMediaPath}facebook.png');
  static final String twitter = _asset('${_socialMediaPath}x.png');
  static final String instagram = _asset('${_socialMediaPath}instagram.png');
  static final String youtube = _asset('${_socialMediaPath}youtube.png');
  static final String linkedin = _asset('${_socialMediaPath}linkedin.png');
