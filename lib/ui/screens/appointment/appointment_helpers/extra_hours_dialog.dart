...
class _ExtraHoursDialogState extends State<ExtraHoursDialog> {
  ...
  void _addTimeSlot() {
    ...
    final hasNoSlots = _timeSlots.isEmpty && _getExistingExtraSlots().isEmpty;

    setState(() {
      _timeSlots.add(
        ExtraTimeSlot(
          id: '',
          startTime: hasNoSlots ? '09:00' : '',
          endTime: hasNoSlots ? '18:00' : '',
          date: dateString,
        ),
      );
    });
  ...
  Widget _buildTimeSlot(ExtraTimeSlot slot) {
    return Row(
      children: [
        Expanded(
