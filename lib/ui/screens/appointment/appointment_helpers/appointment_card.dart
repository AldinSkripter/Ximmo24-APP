...
class _AppointmentCardState extends State<AppointmentCard> {
  ...
  Widget _buildUserInfo(
    ...
    final user = _isAgent
        ? appointment.user
        : appointment.agent ?? appointment.user;
    return Row(
      children: [
        ClipRRect(
          borderRadius: BorderRadius.circular(4),
  ...
  Future<void> _showAppointmentDetails(
    ...
    await CustomBottomSheet.show<void>(
      ...
      title: 'appointmentDetails'.translate(context),
      child: AppointmentDetailsBottomSheet(
      ...
      if (_isAgent) {
        ...
        unawaited(
          context
              ...
              .fetchUserPreviousAppointments(forceRefresh: true),
        );
      }
